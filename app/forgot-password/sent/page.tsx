...
export default async function ResetSent({
  searchParams,
}: {
      ...
      <div className="w-full max-w-md text-center">
        ...
        <div className="rounded-2xl border border-border bg-card p-8 md:p-10 shadow-sm">
          ...
          <p className="text-foreground/70 text-sm leading-relaxed">
            If <span className="font-semibold">{email ?? 'that email'}</span> has an account, we
            sent a one-time reset link. The link works once and expires in 1 hour.
          </p>
