...
await mkdir('/tmp/prequel-center', { recursive: true });
...
const beats = [
  { p: 0.040, label: '01-prequel-l1-typing' },
  { p: 0.070, label: '02-prequel-l1-mostly' },
  { p: 0.085, label: '03-prequel-l1-complete' },
  { p: 0.100, label: '04-prequel-l2-typing' },
  { p: 0.120, label: '05-prequel-hold' },
];
for (const beat of beats) {
  ...
  await p.screenshot({ path: `/tmp/prequel-center/${beat.label}.jpg`, type: 'jpeg', quality: 85 });
